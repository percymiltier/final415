...
#        GameState.explored.add(self)
    ...
    def generatePacmanSuccessor(self, action: Action) -> Self:
        """
    ...
    def getGhostStates(self) -> list[AgentState]:
...
class ClassicGameRules:
    ...
    def newGame(self,
                ...
                display: Graphics,
                quiet: bool = False,
                catchExceptions: bool = False) -> Game:
    ...
    def lose(self, state: GameState, game: GameState) -> None:
...
class PacmanRules:
    ...
    @staticmethod
    def getLegalActions(state: GameState) -> list[Action]:
        """
    ...
    @staticmethod
    def applyAction(state: GameState, action: Action) -> None:
        """
...
class GhostRules:
    ...
    GHOST_SPEED=1.0
    @staticmethod
    def getLegalActions(state, ghostIndex: int) -> list[Action]:
        """
    ...
    @staticmethod
    def applyAction(state: GameState, action: Action, ghostIndex: int) -> None:
    ...
    @staticmethod
    def decrementTimer(ghostState: AgentState) -> None:
    ...
    @staticmethod
    def collide(state: GameState, ghostState: AgentState, agentIndex: int) -> None:
...
def parseAgentArgs(str: str) -> dict[str, str | int]:
    if str == None: return {}
    pieces = str.split(',')
    opts = {}
    for p in pieces:
...
def replayGame(layout: Layout, actions: list[Action], display: Graphics) -> None:
