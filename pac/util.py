...
class PriorityQueue:
    ...
    def push(self, item: Any, priority: Number) -> None:
...
class PriorityQueueWithFunction(PriorityQueue):
    ...
    """
    def __init__(self, priorityFunction: Callable[[Any], float|int]):
...
class Counter(dict):
    ...
    def incrementAll(self, keys: list, count: Number):
        """
    ...
    def divideAll(self, divisor: Number) -> None:
        """
...
def normalize(vectorOrCounter: Iterable[Number] | Counter) -> Iterable[Number] | Counter:
    """
...
Distribution = Iterable[Number] | dict | Counter
def nSample(distribution: Distribution, values: Iterable, n: int) -> list:
...
def sample(distribution: Distribution, values: Iterable | None = None) -> Any:
...
def getProbability(value: Any, distribution: Distribution, values: list) -> Number:
    """
...
def chooseFromDistribution(distribution: Distribution) -> Any:
...
def nearestPoint(pos: tuple[Number, Number]) -> tuple[int, int]:
    """
...
def arrayInvert(array: Iterable[Iterable]) -> list[list]:
    """
...
def matrixAsList(matrix: Iterable[Iterable], value: bool = True ) -> list[tuple[int, int]]:
    """
...
def lookup(name: str, namespace: str) -> Any:
    """
...
class TimeoutFunction:
    ...
    def handle_timeout(self, signum, frame) -> Never:
        raise TimeoutFunctionException()

    def __call__(self, *args, **keyArgs) -> Any:
